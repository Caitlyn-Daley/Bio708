...
```
We can see that the estimates for the tibia in each model are different, and the standard errors are somewhat different as well, which effects t values, etc. 
